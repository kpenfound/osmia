...
// materialize or remove: workflow, transition, question and owned agent files
// of a workstream, private role notes, and project documents other than the charter.
